...
| `tem0052` | `draft` | Substantial partial migration | 16 concepts, 9 exercises, 2 figures, 3 assignments, 10 lectures | One of the core migration tracks; strong canonical slice but not yet fully consolidated |
